...
#from models_mobilenet.s3fd import S3FD_MV2
#from test_mobilenet_img import load_model
...
parser.add_argument('--model', default='ssd', type=str, help='Model type')
