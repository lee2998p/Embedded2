        ...
        if (args.optical_flow):
            ...
            if p0.any() != None:
                ...
                for i, (new, old) in enumerate(zip(good_new, good_old)):
                    ...
                    # 	y_pt = ()
                    if i % 11 == 0:
                        bounding_box = cv2.rectangle(image, (int(a - box_width / 2), int(b - box_height / 2)),
                                                     (int(a + box_width / 2), int(b + box_height / 2)),
                                                     color[i].tolist(), 2)
                        img = cv2.add(image, bounding_box)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--multi_tracking', default=False, type=bool,
