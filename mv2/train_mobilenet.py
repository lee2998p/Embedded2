...
parser = argparse.ArgumentParser(description='S3FD-Mv2 Training')
parser.add_argument('--training_dataset', default='./data_mobilenet/WIDER_FACE', help='Training dataset directory')
parser.add_argument('-b', '--batch_size', default=32, type=int, help='Batch size for training') #changed from 32 to 4 (Arnav)
parser.add_argument('--num_workers', default=16, type=int, help='Number of workers used in dataloading') #changed from 16 to 2 (Arnav)
...
parser.add_argument('-max', '--max_epoch', default=300, type=int, help='max epoch for retraining') #changed from 300 to 2 (Arnav)
